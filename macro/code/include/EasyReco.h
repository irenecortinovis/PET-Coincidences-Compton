...
// Tue Jun 11 18:18:12 2019 by ROOT version 6.16/00
// from TTree realCoincidences/realCoincidences
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         sinogramS;
   Char_t          comptVolName1;
   Char_t          comptVolName2;
   Char_t          RayleighVolName1;
   Char_t          RayleighVolName2;
   ...
   EasyReco(std::string filename="",TTree *tree=0);
   virtual ~EasyReco();
...
#ifdef EasyReco_cxx
EasyReco::EasyReco(std::string filename, TTree *tree) : fChain(0)
{
...
Int_t EasyReco::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EasyReco::LoadTree(Long64_t entry)
{
...
void EasyReco::Show(Long64_t entry)
{
...
Int_t EasyReco::Cut(Long64_t entry)
{
