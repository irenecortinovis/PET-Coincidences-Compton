#ifndef singleCoincidences_h
#define singleCoincidences_h
...
public :
   ...
   singleCoincidences();
   virtual ~singleCoincidences();
   virtual void     Init(TTree *tree);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     FillSingle(std::vector<Hits::CoincidenceEvent> cvector);
...
#ifdef singleCoincidences_cxx
singleCoincidences::singleCoincidences() : fChain(0)
{
...
singleCoincidences::~singleCoincidences()
{
   if (!fChain) return;
...
void singleCoincidences::Init(TTree *tree)
{
  fChain = tree;
...
Long64_t singleCoincidences::LoadTree(Long64_t entry)
{
...
void singleCoincidences::WriteTree()
{
  std::string outFile = "realsingleCoincidencesCompton.root";
...
#endif // #ifdef singleCoincidences_cxx
